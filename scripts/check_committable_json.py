...
#   is skipped the "Validate and generate" step bare-parses it three times over
#   (validate-data.mjs's checkMembers, generate-feeds.js, generate-sitemap.mjs)
#   with no `continue-on-error`. Either way the job is dead before this step
#   exists. What this check still catches is the wrong-*shape* case, which those
#   readers tolerate.
